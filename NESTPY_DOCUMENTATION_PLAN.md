# Nestpy Documentation and Examples Plan

Status: proposed execution plan; implementation has not started.

Nestpy N0-N6 provide the initial framework implementation. This plan turns the
...
1. Install Nestpy and its optional extras.
...
1. `NESTPY_ARCHITECTURE.md` owns architecture and v1 boundaries.
2. `spec/nestpy/` owns executable behavior contracts and failure semantics.
...
uv run pytest packages/nestpy/tests/docs examples/nestpy
```
...
examples/nestpy/
  ...
  operations/
  reference_apps/
packages/nestpy/tests/docs/
packages/nestpy/scripts/verify_docs.py
packages/nestpy/scripts/verify_artifacts.py
```

The existing `examples/nestpy/app.py` becomes either the Getting Started example
...
- Prefer `from nestpy import ...` and documented public subpackage facades.
...
1. Included from a tested file under `examples/nestpy/`.
2. Included from a docs test fixture under `packages/nestpy/tests/docs/`.
...
| E004 | `getting_started/cli_run` | `nestpy run` serving path |
...
Path: `examples/nestpy/reference_apps/task_api/`
...
Path: `examples/nestpy/reference_apps/community_api/`
...
Path: `examples/nestpy/reference_apps/production_blueprint/`
...
- Nestpy N0-N6 tests pass.
- Current examples boot successfully.

Tasks:

1. Run all existing quality gates.
2. Export public symbols from `nestpy`, `nestpy.settings`, `nestpy.starlette`, and
   `nestpy.testing` into an inventory document.
...
6. Add `packages/nestpy/scripts/verify_docs.py`.
...
uv sync --locked --group docs
uv run --group docs mkdocs build --strict
uv run pytest packages/nestpy/tests/docs
uv run python packages/nestpy/scripts/verify_docs.py
```
...
2. Write Why Nestpy without claiming feature parity with NestJS.
...
1. Write CLI installation and `nestpy run` command.
...
uv run ty check packages/cqrs-core/src packages/cqrs-core/tests packages/cqrs-fastapi/src packages/cqrs-fastapi/tests packages/nestpy/src packages/nestpy/tests examples/nestpy packages/nestpy/scripts
uv run --group docs mkdocs build --strict
uv build --package nestpy
uv run python packages/nestpy/scripts/verify_artifacts.py dist/
uv run python packages/nestpy/scripts/verify_docs.py
```
...
```text
Add Nestpy documentation tooling
Write Nestpy Getting Started guide
Document Nestpy modules and providers
Add Nestpy module and provider examples
Document Nestpy scopes and lifecycle
Add Nestpy lifecycle examples
Document Nestpy HTTP bindings
Add Nestpy HTTP examples
Document Nestpy pipeline execution
Add Nestpy pipeline examples
Document Nestpy settings and observability
Add Nestpy settings examples
Document Nestpy testing APIs
Add Nestpy testing examples
Document Nestpy CLI and deployment
Add Nestpy operational examples
Add Nestpy Task API reference application
Add Nestpy Community API reference application
Add Nestpy production blueprint
Generate and review Nestpy API reference
Harden Nestpy documentation release gates
```
...
- Every cross-phase invariant in `spec/nestpy/README.md`.
...
- An example uses a private Nestpy import without an allowlist reason.
