...
ToriPy is useful when application composition should stay inspectable as a
...
Python port and does not claim feature parity. ToriPy uses Python constructor
annotations, async application factories, and explicit ASGI integration.

Use ToriPy when its module and lifecycle model helps. Use Starlette directly
