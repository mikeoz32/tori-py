...
DI-managed global ToriPy middleware, guards, pipes, interceptors, and filters
...
`examples/tori_py/getting_started/asgi_wrapper/app.py`. Its factory configures a
