"""Internal OpenAPI document compiler for compiled Nestpy routes."""
...
import msgspec
from nestpy.core import PipelineResult
from nestpy.http import (
    HttpResponse,
    ParameterPlan,
...
from nestpy_openapi.errors import OpenApiSchemaError
from nestpy_openapi.metadata import MergedMetadata, ResponseMetadata, merge_metadata
