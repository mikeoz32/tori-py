...
`nestpy-openapi` is the optional OpenAPI 3.1 documentation integration for
Nestpy. It discovers Nestpy controllers, compiles their transport-neutral route
mappings, and serves a cached document with an optional Swagger UI.

```python
from typing import Annotated

from nestpy import Path, controller, get, module
...
are ordinary Nestpy controller routes, so guards, pipes, interceptors, filters,
