"""Nestpy CQRS integration for framework-neutral event sourcing."""

from nestpy_cqrs_event_sourcing.decorators import (
    aggregate_repository,
    event_sourcing_transaction,
    use_event_sourcing,
)
from nestpy_cqrs_event_sourcing.errors import (
...
from nestpy_cqrs_event_sourcing.module import CqrsEventSourcingModule
from nestpy_cqrs_event_sourcing.options import (
    CqrsEventSourcingOptions,
    UnitOfWorkFactory,
    default_unit_of_work_factory,
)
from nestpy_cqrs_event_sourcing.synchronization import CommandSynchronization
