...
from cqrs_core import HandlerKind, get_handler_metadata
from cqrs_event_sourcing import AggregateRoot, EventSourcedRepository
from nestpy import BootstrapError, Inject, Reflector, metadata
...
from nestpy_cqrs_event_sourcing.tokens import get_transaction_interceptor_token
...
_AGGREGATE_REPOSITORY = Reflector.create_decorator(
    "nestpy_cqrs_event_sourcing.aggregate_repository"
)
...
def aggregate_repository(
    ...
    *,
    ...
    """Declare a repository class or create its standard Nestpy Inject marker."""
