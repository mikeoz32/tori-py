...
from tori_py_cqrs_event_sourcing.decorators import _repository_metadata
from tori_py_cqrs_event_sourcing.errors import CqrsEventSourcingConfigurationError
from tori_py_cqrs_event_sourcing.options import CqrsEventSourcingOptions
from tori_py_cqrs_event_sourcing.runtime import (
    ...
    def for_root(
        ...
        *,
        ...
        interceptor_factory = _interceptor_factory(
            ...
            completion_key=f"tori_py_cqrs_event_sourcing:{key}",
        )
