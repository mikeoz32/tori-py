...
from examples.tori_py.getting_started.asgi_wrapper.app import application as asgi_app
from examples.tori_py.getting_started.async_factory.app import (
    create_application as async_factory_application,
)
from examples.tori_py.getting_started.cli_run.app import (
    create_application as cli_application,
)
from examples.tori_py.getting_started.first_provider.app import (
    create_application as provider_application,
)
from examples.tori_py.getting_started.first_settings.app import (
    create_application as settings_application,
)
from examples.tori_py.getting_started.hello_world.app import (
    application as hello_asgi_app,
)
from examples.tori_py.getting_started.hello_world.app import (
    create_application as hello_application,
)
from examples.tori_py.getting_started.project_structure.app import (
...
@pytest.mark.parametrize(
    ...
    [
        (hello_application, "/hello", {"message": "Hello, ToriPy!"}),
        (
...
@pytest.mark.parametrize(
    ...
    [
        (hello_asgi_app, "/hello", {"message": "Hello, ToriPy!"}),
