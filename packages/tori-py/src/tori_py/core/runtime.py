...
from tori_py.core.discovery import RuntimeDiscoveryService, RuntimeModulesContainer
...
from tori_py.core.options import ApplicationOptions
    ...
    def __init__(
        ...
        *,
        ...
        self._executor = ThreadPoolExecutor(
            max_workers=4,
            thread_name_prefix="tori_py-resource",
        )
...
def _attach_cleanup_notes(
    ...
    for error in cleanup_errors:
        body_error.add_note(
            f"ToriPy scope cleanup failed: {type(error).__name__}: {error}"
        )
