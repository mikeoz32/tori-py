...
from tori_py.core.modules import DeferredModule, ModuleSpec
from tori_py.core.protocols import Logger
from tori_py.core.providers import FactoryProvider
...
class PythonLogger:
    ...
    def __init__(
        ...
        self._logger = logger or std_logging.getLogger("tori_py")
    ...
    def _write(
        ...
        self._logger.log(level, message, extra={"tori_py": merged})
...
class LoggingModule:
    ...
    def for_root(
        cls,
        *,
        application: str = "tori_py",
        logger_name: str = "tori_py",
