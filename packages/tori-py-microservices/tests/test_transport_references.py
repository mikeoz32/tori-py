...
import pytest
import tori_py_microservices.clients as clients_module
import tori_py_microservices.module as server_module
from tori_py import ClassProvider, DeferredModule, ModuleSpec, ValueProvider, module
...
class FakeServerFactory:
    ...
    def create(self, identity, options):
        del options
        from tori_py_microservices import InMemoryServerTransport
