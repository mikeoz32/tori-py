...
import tori_py_microservices.rabbitmq
...
import tori_py_microservices.rabbitmq.dependencies as dependencies
from tori_py_microservices import OptionalDependencyError
...
try:
    ...
    assert "tori-py-microservices[rabbitmq]" in str(error)
else:
