# ToriPy Microservices User Guide
...
Importing `tori_py_microservices` or its RabbitMQ facade does not import
...
from tori_py import Context, controller
from tori_py_microservices import Payload, RpcContext, rpc
...
same ToriPy application, while keeping HTTP routing and message routing as
...
[`examples/tori_py/microservices`](../../../examples/tori_py/microservices/README.md).
The application-level
[`microservices_app`](../../../examples/tori_py/microservices_app/README.md)
