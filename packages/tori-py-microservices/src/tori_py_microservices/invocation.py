...
from tori_py_microservices.contexts import EventContext, MessageContext, RpcContext
...
from tori_py_microservices.plans import (
    EventHandlerPlan,
    MessageParameterPlan,
    PipelinePlan,
    RpcHandlerPlan,
)
from tori_py_microservices.wire import RESULT_MISSING, freeze_headers
...
class MessagePipelineExecutor:
    ...
    async def invoke(
        ...
        *,
        ...
        """Run one attempt through a fresh exact-owner ToriPy work scope."""
