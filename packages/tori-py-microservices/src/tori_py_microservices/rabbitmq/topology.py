...
from tori_py_microservices.identities import ReplyRoute, ServiceIdentity
from tori_py_microservices.transport import EventSubscription

_MAX_NAME_BYTES = 255
_MAX_EXCHANGE_NAME_BYTES = 127
_DEAD_LETTER_EXCHANGE = "tori_py.dead-letter"
...
def compile_rpc_topology(
    ...
    *,
    ...
    queue = f"tori_py.rpc.{service.label}"
...
def compile_event_topology(
    ...
    *,
    ...
    prefix = (
        f"tori_py.event.{identity.source.label}.{identity.event}."
