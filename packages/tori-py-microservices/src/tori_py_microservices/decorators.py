...
from tori_py import Inject, MetadataKey, metadata
...
_RPC_KEY: MetadataKey[RpcMetadata] = MetadataKey("tori_py.microservices.rpc")
_EVENT_KEY: MetadataKey[EventHandlerMetadata] = MetadataKey(
    "tori_py.microservices.event_handler"
)
...
def rpc(method: str | Callable[..., object], *, schema_version: int = 1):
    ...
    if not isinstance(method, str):
        from tori_py_microservices.contracts import (
