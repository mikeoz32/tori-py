...
import msgspec
from tori_py import MetadataKey, Reflector, metadata

from tori_py_microservices.cluster import ServiceCluster, ServiceProxy
from tori_py_microservices.errors import HandlerCompilationError
...
_CONTRACT_KEY: MetadataKey[ServiceContractMetadata] = MetadataKey(
    "tori_py.microservices.service_contract"
)
_CALL_KEY: MetadataKey[RpcCallMetadata] = MetadataKey("tori_py.microservices.rpc_call")
