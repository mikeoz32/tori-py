"""Deferred ToriPy module descriptor for one service root."""
...
from tori_py_microservices.identities import ServiceIdentity
from tori_py_microservices.options import MicroservicesOptions
from tori_py_microservices.runtime import ServiceRuntime
