...
`cqrs-event-sourcing` provides framework-neutral event-sourcing primitives for
`cqrs-core`:
...
`CQRS_EVENT_SOURCING_IMPLEMENTATION_PLAN.md` and
`spec/cqrs-event-sourcing/README.md` at the workspace root.
