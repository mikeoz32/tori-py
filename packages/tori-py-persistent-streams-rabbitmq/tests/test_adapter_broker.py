...
async def test_tori_py_module_publisher_handler_and_lifecycle() -> None:
    received: list[str] = []
...
async def test_tori_py_quiesce_waits_for_blocked_handler_checkpoint() -> None:
...
async def test_tori_py_failure_abandons_delivery_without_shutdown_delay(
    failure: str,
) -> None:
