...
if TYPE_CHECKING:
    ...
    from tori_py_persistent_streams_rabbitmq.errors import (
        EnvelopeError,
        RabbitMqPersistentStreamsError,
        TopologyConflictError,
    )
    from tori_py_persistent_streams_rabbitmq.log import (
        RabbitMqPartitionLease,
        RabbitMqPersistentLog,
        TopologyPreflight,
    )
    from tori_py_persistent_streams_rabbitmq.options import (
        DeclarationMode,
    ...
    from tori_py_persistent_streams_rabbitmq.tori_py import (
...
_MODULES = {
    ...
    "RabbitMqPersistentStreamsModule": "tori_py",
    "RabbitMqStreamAdapterFactory": "tori_py",
}
