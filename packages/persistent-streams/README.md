...
`persistent-streams` defines framework-neutral, asynchronous contracts for an
...
Future adapters must invoke `persistent_streams.testing.run_conformance_suite`
...
Use [`nestpy-persistent-streams`](../nestpy-persistent-streams/README.md) for
Nestpy handler discovery, execution pipelines, and typed publishers. The
[`persistent-streams-rabbitmq`](../persistent-streams-rabbitmq/README.md) adapter
