"""Dynamic ToriPy module for async SQLAlchemy resources."""
...
from tori_py_sqlalchemy.managers import EntityManager
from tori_py_sqlalchemy.options import SqlAlchemyOptions, SqlAlchemySessionOptions
from tori_py_sqlalchemy.repository import (
    Repository,
    _repository_metadata,
)
from tori_py_sqlalchemy.runtime import (
    ...
    *,
    ...
    return [
        ...
        FactoryProvider(
            ...
            _entity_manager_factory(session_factory_token),
            manage=False,
        ),
    ]
...
def _exports(key: str) -> tuple[Token, ...]:
    ...
    if key == "default":
        exports.extend((AsyncEngine, EntityManager))
