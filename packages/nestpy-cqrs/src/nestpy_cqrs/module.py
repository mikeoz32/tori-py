"""Dynamic Nestpy CQRS module composition."""

from collections.abc import Iterable

from cqrs_core import CommandBus, CqrsBuses, EventBus, QueryBus
from nestpy import (
    AliasProvider,
    ClassProvider,
    DeferredModule,
...
from nestpy_cqrs.provider import (
    NestpyHandlerProvider,
    _binding_plan,
    _BindingPlan,
    _explicit_bindings,
    _ExplicitBindings,
)
from nestpy_cqrs.runtime import (
    _buses,
    _command_bus,
    _CqrsRuntime,
    _create_runtime,
...
class CqrsModule:
    """Compose one discovered CQRS graph as a keyed Nestpy dynamic module."""
            ...
            return ModuleSpec(
                ...
                providers=(
                    *aliases,
                    ...
                    ClassProvider(NestpyHandlerProvider),
