...
from tori_py_cqrs_core import DispatchContext, Envelope, HandlerKind, Message

from tori_py_cqrs.errors import CqrsConfigurationError, CqrsPipelineStateError
...
class CqrsInvocationContext(ExecutionContext):
    """ToriPy execution context for one CQRS handler invocation."""
...
_CQRS_INTERCEPTORS_ATTRIBUTE = "__tori_py_cqrs_interceptors__"
