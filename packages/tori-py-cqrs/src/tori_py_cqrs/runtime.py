"""CQRS graph assembly and ToriPy lifecycle coordination."""
...
from tori_py import ShutdownContext
...
from tori_py_cqrs.errors import CqrsConfigurationError, CqrsLifecycleError
from tori_py_cqrs.options import CqrsModuleOptions, TransportFactory
from tori_py_cqrs.provider import ToriPyHandlerProvider, _BindingPlan
...
def _create_runtime(
    ...
    provider: ToriPyHandlerProvider,
    plan: _BindingPlan,
