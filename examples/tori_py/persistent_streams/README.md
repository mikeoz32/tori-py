...
the adapter [supported contract and limits](../../../packages/tori-py-persistent-streams-rabbitmq/README.md)
and its [operations guide](../../../packages/tori-py-persistent-streams-rabbitmq/OPERATIONS.md)
