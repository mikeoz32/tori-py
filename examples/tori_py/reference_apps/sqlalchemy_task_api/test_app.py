"""Acceptance tests for the non-CQRS ToriPy SQLAlchemy example."""
...
from examples.tori_py.reference_apps.sqlalchemy_task_api.app import (
...
def test_sqlalchemy_task_api_imports_no_cqrs_packages() -> None:
    script = """
import sys
import examples.tori_py.reference_apps.sqlalchemy_task_api.app
