"""Nestpy composition root for the event-sourced community project."""
...
from examples.nestpy.cqrs.event_sourcing.api import (
    AuthenticationGuard,
    CommunityController,
    CommunityErrorFilter,
)
from examples.nestpy.cqrs.event_sourcing.application.handlers import (
