...
The wrapper creates and starts the Nestpy application once during ASGI lifespan.
...
```text
uv run nestpy run examples.nestpy.getting_started.asgi_wrapper.app:create_application
```
