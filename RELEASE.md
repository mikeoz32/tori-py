...
The initial `0.1.0` train publishes all 14 distributions together. Every
...
4. Confirm exactly 28 artifacts pass metadata, dependency, README, legal-file,
...
are immutable. Retry with the exact same 28 files and digest manifest.
...
6. Verify all 28 PyPI hashes against `release-digests.json`, perform a clean
