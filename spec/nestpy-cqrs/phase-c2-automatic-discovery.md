...
Register CQRS handlers from classes already declared as Nestpy providers, so an
...
- startup, cancellation, cleanup, Starlette coexistence, and isolated artifact
  tests remain green.
- `examples/nestpy/cqrs/advanced` demonstrates the complete discovery, scoped
