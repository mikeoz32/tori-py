...
focused tests, Docker-backed tests, docs verification, isolated built-artifact
verification, and independent release review are complete.
...
- Boundaries from CQRS, event sourcing, SQLAlchemy, outbox/inbox, and application
  service extraction.
...
- The package is releasable without changes to ToriPy core dependencies.
