# ToriPy Microservices Specifications
...
1. `tori-py-microservices` depends on ToriPy; ToriPy never depends on it.
...
7. Every delivery attempt receives a fresh exact-owner ToriPy work scope.
