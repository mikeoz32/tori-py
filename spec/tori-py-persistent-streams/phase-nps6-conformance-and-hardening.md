...
ToriPy adapter lifecycle/execution suite proves:
...
- RabbitMQ objects map to core conformance through its `PersistentLog` and to
  ToriPy conformance through its configured adapter factory/runtime.
...
- ToriPy lifecycle/execution conformance suite against a deterministic fake.
