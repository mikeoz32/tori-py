...
- ToriPy N0-N7, `tori-py-cqrs` C0-C2, and `tori-py-cqrs-event-sourcing-core` ES0-ES5 pass.
- The architecture document has no unresolved first-slice decisions.

## Deliverables

- Workspace package `packages/tori-py-cqrs-event-sourcing`.
...
The package MUST NOT publicly re-export the complete APIs of ToriPy,
`tori-py-cqrs`, or `tori-py-cqrs-event-sourcing-core`.
