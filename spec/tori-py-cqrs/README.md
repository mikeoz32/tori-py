# ToriPy CQRS Integration Plan

This directory specifies the optional `tori-py-cqrs` package. It consumes public
ToriPy contracts and `tori-py-cqrs-core` without creating reverse dependencies. C0-C3
are implemented.
