...
Expose a public ToriPy-style interceptor seam around CQRS handler invocation
without coupling `tori-py-cqrs` to persistence or HTTP.

## Contract

- Public `CqrsInvocationContext` implements ToriPy `ExecutionContext`.
