...
Status: conditional after final structural review. Facade, documentation, and
ordinary/Super Stream acceptance pass focused coverage. The latest repository-wide
pytest run has one unrelated migration checksum failure; Ruff, format, Ty, and
artifact verification pass. Deferred RPS5/RPS6 operational
and cluster gates block unconditional release.
...
- Run core and Nestpy conformance as separate gates.
